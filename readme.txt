...
`[alert type="type"]hidden text[/alert]`

Alert types:

`[alert type="info"]Alert here![/alert]`
`[alert type="success"]Alert here![/alert]`
`[alert type="warning"]Alert here![/alert]`
`[alert type="error"]Alert here![/alert]`
